...
export const mockGitHubRepos = [
  ...
  {
    id: 4,
    node_id: 'R_kgDOGq0qNA',
    name: 'create-react-app-vite',
    full_name: 'laststance/create-react-app-vite',
    owner: {
      login: 'laststance',
      avatar_url: 'https://avatars.githubusercontent.com/u/100?v=4',
    },
    description: 'Create React App + Vite template',
    html_url: 'https://github.com/laststance/create-react-app-vite',
    homepage: 'https://github.com/laststance/create-react-app-vite',
  ...
  {
    id: 5,
    node_id: 'R_kgDOGq0qNB',
    name: 'nsx',
    full_name: 'laststance/nsx',
    owner: {
      login: 'laststance',
      avatar_url: 'https://avatars.githubusercontent.com/u/100?v=4',
    },
    description: 'Monorepo workspace CLI tool',
    html_url: 'https://github.com/laststance/nsx',
    homepage: 'https://www.npmjs.com/package/nsx',
    stargazers_count: 85,
    watchers_count: 85,
    language: 'TypeScript',
    topics: ['cli', 'monorepo', 'npm'],
