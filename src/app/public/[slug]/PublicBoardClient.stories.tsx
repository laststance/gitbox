...
export const WithSubtitle: Story = {
  args: {
    data: {
      ...
      statusLists: [
        {
          id: toStatusListId('status-5'),
          title: 'To Do',
          color: '#ef4444',
          gridRow: 0,
          gridCol: 0,
          boardId: toBoardId('board-3'),
          createdAt: '2024-01-01T00:00:00.000Z',
          updatedAt: '2024-01-01T00:00:00.000Z',
        },
      ],
      repoCards: [
        {
          id: toRepoCardId('card-4'),
          title: 'typescript',
          repoOwner: 'microsoft',
          repoName: 'TypeScript',
          description:
            'TypeScript is a superset of JavaScript that compiles to clean JavaScript output.',
          statusId: toStatusListId('status-5'),
          boardId: toBoardId('board-3'),
          order: 0,
...
export const ManyCards: Story = {
  args: {
    data: {
      ...
      statusLists: [
        {
          id: toStatusListId('status-6'),
          title: 'Backlog',
          color: '#6b7280',
          gridRow: 0,
          gridCol: 0,
          boardId: toBoardId('board-4'),
          createdAt: '2024-01-01T00:00:00.000Z',
          updatedAt: '2024-01-01T00:00:00.000Z',
        },
        {
          id: toStatusListId('status-7'),
          title: 'In Progress',
          color: '#3b82f6',
          gridRow: 0,
          gridCol: 1,
      ...
      repoCards: [
        {
          id: toRepoCardId('card-10'),
          title: 'react',
          repoOwner: 'facebook',
          repoName: 'react',
          description: 'A declarative UI library.',
          statusId: toStatusListId('status-6'),
          boardId: toBoardId('board-4'),
          order: 0,
          meta: { stars: 220000, language: 'JavaScript' },
          createdAt: '2024-01-01T00:00:00.000Z',
        ...
        {
          id: toRepoCardId('card-14'),
          title: 'next.js',
          repoOwner: 'vercel',
          repoName: 'next.js',
          description: 'The React Framework.',
          statusId: toStatusListId('status-7'),
          boardId: toBoardId('board-4'),
          order: 0,
          meta: { stars: 125000, language: 'TypeScript' },
          createdAt: '2024-01-01T00:00:00.000Z',
        ...
        {
          id: toRepoCardId('card-17'),
          title: 'astro',
          repoOwner: 'withastro',
          repoName: 'astro',
          description: 'The web framework for content-driven websites.',
          statusId: toStatusListId('status-8'),
          boardId: toBoardId('board-4'),
          order: 0,
