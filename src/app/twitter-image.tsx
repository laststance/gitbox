 ...
 * Twitter Card Image
 *
 * Dynamic generation of Twitter Card image.
 * Uses the same design as OG image but with Twitter-specific dimensions.
 *
  ...
  return new ImageResponse(
    ...
    >
      ...
      >
        ...
        >
          <svg width="56" height="56" viewBox="0 0 24 24" fill="#1f2328">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
      ...
      >
        {['Pending', 'In Progress', 'Review', 'Done'].map((label) => (
          ...
          >
            <span style={{ fontSize: 16, color: '#8b949e' }}>{label}</span>
          </div>
        ))}
      </div>
    </div>,
